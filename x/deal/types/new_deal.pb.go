...
type NewDeal struct {
	DealId     uint64 `protobuf:"varint,1,opt,name=dealId,proto3" json:"dealId,omitempty"`
...
func (m *NewDeal) GetDealId() uint64 {
	if m != nil {
		return m.DealId
	}
	return 0
...
var fileDescriptor_f26f39c3dcb2c0e1 = []byte{
	...
	0xa8, 0xc0, 0xa8, 0xc1, 0x12, 0x04, 0xe5, 0x09, 0x89, 0x70, 0xb1, 0xe6, 0x97, 0xe7, 0xa5, 0x16,
	0x49, 0x30, 0x29, 0x30, 0x6a, 0x70, 0x06, 0x41, 0x38, 0x20, 0xd5, 0x65, 0xa9, 0x79, 0x29, 0xf9,
	0x45, 0x12, 0xcc, 0x60, 0x61, 0x28, 0x4f, 0x48, 0x8e, 0x8b, 0x2b, 0x39, 0x3f, 0x37, 0x37, 0xb3,
	0xb8, 0x38, 0x33, 0x3f, 0x4f, 0x82, 0x05, 0x6c, 0x12, 0x92, 0x88, 0x93, 0xc3, 0x89, 0x47, 0x72,
	...
	0xe7, 0xe7, 0xea, 0x83, 0x5d, 0xaa, 0x6b, 0x60, 0x64, 0xae, 0x0f, 0xf6, 0x48, 0x05, 0x84, 0x2a,
	0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0xfb, 0xc6, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x0a,
	0xc8, 0xe3, 0x78, 0xe4, 0x00, 0x00, 0x00,
}
...
func (m *NewDeal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DealId != 0 {
		i = encodeVarintNewDeal(dAtA, i, uint64(m.DealId))
		i--
		dAtA[i] = 0x8
	}
...
func (m *NewDeal) Size() (n int) {
	...
	_ = l
	if m.DealId != 0 {
		n += 1 + sovNewDeal(uint64(m.DealId))
	}
	l = len(m.Owner)
	if l > 0 {
